...
import com.api.doc.detail.util.ooxml.ExcelException;
 ...
 *
 */
public class HR05LizhiZZZEndAction extends AbstractAction{
	
	private static Logger LOGGER = Logger.getLogger(HR05LizhiZZZEndAction.class);
	...
	public void execute() throws Exception {
		...
		if(!value.equals("")) {
			...
			throw new ExcelException("HR05LizhiZZZEndAction");
		}
